...
class Ui_WindowClassDetail(object):
    def setupUi(self, WindowClassDetail):
        ...
        self.treeview_students = QtWidgets.QTreeWidget(parent=self.centralwidget)
        self.treeview_students.setObjectName("treeview_students")
        self.treeview_students.headerItem().setText(0, "1")
        self.verticalLayout_4.addWidget(self.treeview_students)
        ...
        self.treeview_exams = QtWidgets.QTreeWidget(parent=self.centralwidget)
        self.treeview_exams.setObjectName("treeview_exams")
        self.treeview_exams.headerItem().setText(0, "1")
        self.verticalLayout_5.addWidget(self.treeview_exams)
        ...
        self.treeview_categories = QtWidgets.QTreeWidget(parent=self.centralwidget)
        self.treeview_categories.setObjectName("treeview_categories")
        self.treeview_categories.headerItem().setText(0, "1")
        self.verticalLayout_6.addWidget(self.treeview_categories)
